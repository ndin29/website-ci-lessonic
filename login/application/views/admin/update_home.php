...
<div class="container-fluid">
    ...
    $id         = $_POST['idEdit'];
    $sqlEdit    = mysqli_query($con, "SELECT * FROM home WHERE id = '$_POST[idEdit]'");
        ...
        <div class="col-lg-8">
            ...
            if ($_POST['judul'] != '') {
                ...
                if ($judul != '' && $deskripsi != '' && $gambar_nama == '') {
                    $con = mysqli_connect("localhost", "root", "", "lessonic");
                    $edit = mysqli_query($con, "UPDATE `home` SET judul = '$judul' , deskripsi = '$deskripsi' WHERE id = '" . $_POST['idEdit'] . "'");
                    ...
                    $con = mysqli_connect("localhost", "root", "", "lessonic");
                    $edit = mysqli_query($con, "UPDATE `home` SET judul = '$judul' , deskripsi = '$deskripsi' , gambar = '$gambar' WHERE id = '" . $_POST['idEdit'] . "'");
